...
## Related Queries
- `../../queries/billing/churn_by_segment.sql` — Churn broken down by customer segment
...
## Related Schemas
- `../../schemas/billing/billing_events.md` — The billing_events table structure
- `../../schemas/billing/subscriptions.md` — The subscriptions table structure

## Related in feature-index.yaml

These metrics power the **billing** product area in `product-development/feature-index.yaml`. Register a feature there to cross-link its PRD, RFC, plan, and dashboard with these metrics.
