...
Run queries/churn_by_segment.sql and check:
...
- Was there a price change in the last 30 days? Check decisions/ folder for recent pricing decisions.
- Was there an outage or incident? Check engineering/bugs/ for recent P0/P1 incidents.
- Did a competitor launch something? Check product/competitive-research/ for recent entries.
...
Create a new file in engineering/bugs/ or product/decisions/ with:
- What the spike was
