...
5. Identifies files that SHOULD have been updated but weren't (e.g., metrics.md for a product area that shipped a feature recently)
...
- schemas/ files (table structures rarely change)
- playbooks/ files (investigation methodologies are stable)
- team/onboarding/ files (guides don't change weekly)
- .claude/skills/ files (skills are updated intentionally, not on a schedule)
...
### Aging (30-90 days — review if still accurate)
- product-development/product/competitive-research/competitor-x.md — 45 days — Owner: [from roster]
- ...
